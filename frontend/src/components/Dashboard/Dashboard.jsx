    ...
    <div className="app-shell">
      ...
      <header className="topbar">
        <div className="topbar-brand">
          ...
          <div className="topbar-title-group">
            ...
            <span className="topbar-subtitle">Automated Trial Registration & M3U Harvester</span>
          </div>
        </div>
      ...
      {backendError && (
        <div className="backend-error-banner">
          <span>⚠️ {backendError} — ensure the backend is running at <strong>http://localhost:3001</strong></span>
        </div>
      )}
